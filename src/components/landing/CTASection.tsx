  ...
  return (
    <section id="cta" className="py-24 px-6">
      <motion.div
        ...
        className="max-w-5xl mx-auto bg-gradient-to-b from-navy to-navy-deep rounded-[2rem] p-8 md:p-16 text-center text-primary-foreground relative overflow-hidden shadow-2xl"
      >
        <motion.div
          ...
          <AnimatePresence mode="wait">
            {!submitted ? (
              ...
              >
                ...
                <motion.button
                  type="submit"
                  className="bg-copper hover:brightness-90 text-primary-foreground px-8 py-4 rounded-full font-bold transition-all flex items-center justify-center gap-2 group"
